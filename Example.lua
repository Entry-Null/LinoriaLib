if not syn or not protectgui then
    ...
    local trashtalktbl = {"pike 360", "rip bozo 🔥💯 rip bozo 🔥💯 rip bozo 🔥💯", "You penetrated yourself with a nerfgun", "".. game.Players.LocalPlayer.Name .. " on top during mother visits", "aim like washing machine", "teeth are doing the cupid shuffle", "folded like a commercial grade lawn chair", "trashbin", "cope", "seethe", "mald", "vouch", "get 1984'd", "get mlk'd", "get jfk'd", "obtain realism", "get real", "dnc (do not care)", "toilet roll for a neck", "dirty dyslexic monkey"}

    Crim:AddButton("Trash Talk", function ()
        realChat(trashtalktbl[math.random(#trashtalktbl)])
    end):AddKeyPicker('Test', { Text = 'Trash Talk', Default = 'h' });
